  ...
  googletag.cmd.push(function() {
    ...
    if (pageVariables["environment"] !== "NoAds") {
        ...
        slot_Box_Mobile_Article_8 = googletag.defineSlot('/23209726049/DagsavisenDK/Box_Mobile_Article_8', getFluidAdSizes("mobile"), "div-Box_Mobile_Article_8").addService(googletag.pubads());
            ...
            slot_Board_1 = googletag.defineSlot('/23209726049/DagsavisenDK/Board_1', getAdSizes("topboard"), "div-Board_1").addService(googletag.pubads());
            slot_Board_2 = googletag.defineSlot('/23209726049/DagsavisenDK/Board_2', getFluidAdSizes("board"), "div-Board_2").addService(googletag.pubads());
            slot_Board_3 = googletag.defineSlot('/23209726049/DagsavisenDK/Board_3', getFluidAdSizes("board"), "div-Board_3").addService(googletag.pubads());
            /* if (pageVariables["viewport-width"] > desktopMinViewportWidth) {
  ...
  var adsScrollListener = function() {
    ...
    if ((slot_Box_Article_3 !== undefined) && !refreshedMap["div-Box_Article_3"] && isParagraphWithinYOffset(15, desktop_delta)) {
     ...
     if ((slot_Box_1 !== undefined) && !refreshedMap["div-Box_1"] && isAdunitWithinYOffset("div-Box_1", desktop_delta)) {
        ...
        if ((slot_Board_2 !== undefined) && !refreshedMap["div-Board_2"] && isAdunitWithinYOffset("div-Board_2", desktop_delta)) {
            googletag.cmd.push(function() {
                googletag.display("div-Board_2"); //new
                refreshAdslot(slot_Board_2);
            });
        }
        if ((slot_Board_3 !== undefined) && !refreshedMap["div-Board_3"] && isAdunitWithinYOffset("div-Board_3", desktop_delta)) {
          googletag.cmd.push(function() {
