...
/* window.ID5EspConfig = {
  ...
  var usingIabCMP, googletag, pbjs, PREBID_TIMEOUT, myPrebidTimeout, prebidEnabled, mobileMaxViewportWidth, tabletMinViewportWidth, tabletMaxViewportWidth, desktopMinViewportWidth, is_mobile, is_desktop, connectionNG, slot_Box_Mobile_Article_1, slot_Box_Mobile_Article_2, slot_Box_Mobile_Article_3, slot_Box_Mobile_Article_4, slot_Box_Mobile_Article_5, slot_Box_Mobile_Article_6, slot_Box_Mobile_Article_7, slot_Box_Mobile_Article_8, slot_Leaderboard_1, slot_Leaderboard_2, slot_Leaderboard_3, slot_Box_1, slot_Box_Article_1, slot_Box_Article_2, slot_Box_Article_3, slot_Box_Article_4, slot_Box_Article_5, slot_160x600_L, slot_160x600_R, slot_1x1, slot_Box_Mobile_1, slot_Box_Mobile_2, slot_Box_Mobile_3, slot_Mobile_Anchor, adslotStates, contentAreaMaxWidth, deviceClassification, testSupportsES6, supportsES6, browserName, pageVariables, cookieCMP, tcString, paragraphCSS3Selector, paragraphCSS2Selector;
  PREBID_TIMEOUT = 1500;
  mobileMaxViewportWidth = 727;
  tabletMaxViewportWidth = 767;
  contentAreaMaxWidth = 1000;
  usingIabCMP = true;
  cookieCMP = "GAM";
        ...
        if (is_desktop) {
           ...
           /* {
                ...
                bids: [{
                    bidder: adform,
                    params: {
                        mid: getBidderID('gpt_unit_/23209726049/DagsavisenDK/Mobile_Anchor_0', adform),
                        url: pageVariables["canonical-url"],
                        //mkw: adform_keys,
                        mkv: pageVariables["adform-keyvalues"]
                    }
...
/*   function createSidebanners () {
    ...
    try {
      ...
      if ( (slot_1x1 !== undefined) && !refreshedMap["div-1x1"] ) {
        ...
        //banner_div_Leaderboard_1.setBefore(target);
            ...
            if ((slot_Box_Mobile_Article_1 !== undefined) && !refreshedMap["div-Box_Mobile_Article_1"]) {           
                try {
                        googletag.cmd.push(function() {
            ...
            if ((slot_Box_Mobile_1 !== undefined) && !refreshedMap["div-Box_Mobile_1"] && pageVariables["subsection-category"] !== "articlepage") {
                googletag.cmd.push(function() {
                    googletag.display("div-Box_Mobile_1"); //new
                    refreshAdslot(slot_Box_Mobile_1);
                });
            }
            if ((slot_Box_Mobile_2 !== undefined) && !refreshedMap["div-Box_Mobile_2"] && isAdunitWithinYOffset("div-Box_Mobile_2", mobile_delta) && pageVariables["subsection-category"] !== "articlepage") {
                googletag.cmd.push(function() {
                    googletag.display("div-Box_Mobile_2"); //new
                    refreshAdslot(slot_Box_Mobile_2);
                });
            }
            if ((slot_Box_Mobile_3 !== undefined) && !refreshedMap["div-Box_Mobile_3"] && isAdunitWithinYOffset("div-Box_Mobile_3", mobile_delta) && pageVariables["subsection-category"] !== "articlepage") {
              googletag.cmd.push(function() {
    ...
    if (pageVariables["environment"] !== "NoAds") {
        if (is_mobile) {
            /* if (pageVariables["subsection-category"] === "articlepage") { */
                slot_Box_Mobile_Article_1 = googletag.defineSlot('/23209726049/DagsavisenDK/Box_Mobile_Article_1', getFluidAdSizes("mobile"), "div-Box_Mobile_Article_1").addService(googletag.pubads());
                slot_Box_Mobile_Article_2 = googletag.defineSlot('/23209726049/DagsavisenDK/Box_Mobile_Article_2', getFluidAdSizes("mobile"), "div-Box_Mobile_Article_2").addService(googletag.pubads());
                slot_Box_Mobile_Article_3 = googletag.defineSlot('/23209726049/DagsavisenDK/Box_Mobile_Article_3', getFluidAdSizes("mobile"), "div-Box_Mobile_Article_3").addService(googletag.pubads());
                slot_Box_Mobile_Article_4 = googletag.defineSlot('/23209726049/DagsavisenDK/Box_Mobile_Article_4', getFluidAdSizes("mobile"), "div-Box_Mobile_Article_4").addService(googletag.pubads());
                slot_Box_Mobile_Article_5 = googletag.defineSlot('/23209726049/DagsavisenDK/Box_Mobile_Article_5', getFluidAdSizes("mobile"), "div-Box_Mobile_Article_5").addService(googletag.pubads());
                slot_Box_Mobile_Article_6 = googletag.defineSlot('/23209726049/DagsavisenDK/Box_Mobile_Article_6', getFluidAdSizes("mobile"), "div-Box_Mobile_Article_6").addService(googletag.pubads());
        slot_Box_Mobile_Article_7 = googletag.defineSlot('/23209726049/DagsavisenDK/Box_Mobile_Article_7', getFluidAdSizes("mobile"), "div-Box_Mobile_Article_7").addService(googletag.pubads());
        slot_Box_Mobile_Article_8 = googletag.defineSlot('/23209726049/DagsavisenDK/Box_Mobile_Article_8', getFluidAdSizes("mobile"), "div-Box_Mobile_Article_8").addService(googletag.pubads());
            /* } */
            slot_Box_Mobile_1 = googletag.defineSlot('/23209726049/DagsavisenDK/Box_Mobile_1', getFluidAdSizes("mobile"), 'div-Box_Mobile_1').addService(googletag.pubads());
            slot_Box_Mobile_2 = googletag.defineSlot('/23209726049/DagsavisenDK/Box_Mobile_2', getFluidAdSizes("mobile"), 'div-Box_Mobile_2').addService(googletag.pubads());
            slot_Box_Mobile_3 = googletag.defineSlot('/23209726049/DagsavisenDK/Box_Mobile_3', getFluidAdSizes("mobile"), 'div-Box_Mobile_3').addService(googletag.pubads());
            slot_Mobile_Anchor = googletag.defineOutOfPageSlot('/23209726049/DagsavisenDK/Mobile_Anchor', googletag.enums.OutOfPageFormat.BOTTOM_ANCHOR);
            if (slot_Mobile_Anchor) {
                slot_Mobile_Anchor.addService(googletag.pubads());
            }
        } else {
            slot_Leaderboard_1 = googletag.defineSlot('/23209726049/DagsavisenDK/Board_1', getAdSizes("topboard"), "div-Board_1").addService(googletag.pubads());
            slot_Leaderboard_2 = googletag.defineSlot('/23209726049/DagsavisenDK/Board_2', getFluidAdSizes("board"), "div-Board_2").addService(googletag.pubads());
            slot_Leaderboard_3 = googletag.defineSlot('/23209726049/DagsavisenDK/Board_3', getFluidAdSizes("board"), "div-Board_3").addService(googletag.pubads());
            /* if (pageVariables["viewport-width"] > desktopMinViewportWidth) {
      ...
      if (pageVariables['viewport-width'] > 1675) {
                slot_160x600_L = googletag.defineSlot('/23209726049/DagsavisenDK/160x600_L', getAdSizes("skyscraper"), "div-160x600_L").addService(googletag.pubads());
                slot_160x600_R = googletag.defineSlot('/23209726049/DagsavisenDK/160x600_R', getAdSizes("skyscraper"), "div-160x600_R").addService(googletag.pubads());
            }
            /* if (pageVariables["subsection-category"] === "articlepage") { */
        slot_Box_Article_1 = googletag.defineSlot('/23209726049/DagsavisenDK/Box_Article_1', getAdSizes("intext"), "div-Box_Article_1").addService(googletag.pubads());
        slot_Box_Article_2 = googletag.defineSlot('/23209726049/DagsavisenDK/Box_Article_2', getAdSizes("intext"), "div-Box_Article_2").addService(googletag.pubads());
        slot_Box_Article_3 = googletag.defineSlot('/23209726049/DagsavisenDK/Box_Article_3', getAdSizes("intext"), "div-Box_Article_3").addService(googletag.pubads());
        slot_Box_Article_4 = googletag.defineSlot('/23209726049/DagsavisenDK/Box_Article_4', getAdSizes("intext"), "div-Box_Article_4").addService(googletag.pubads());
        slot_Box_Article_5 = googletag.defineSlot('/23209726049/DagsavisenDK/Box_Article_5', getAdSizes("intext"), "div-Box_Article_5").addService(googletag.pubads());
            /* }  */ 
        }
        slot_1x1 = googletag.defineSlot('/23209726049/DagsavisenDK/1x1', getAdSizes("pixel"), "div-1x1").addService(googletag.pubads());
    }
                            ...
                            if (success) {
                                ...
                                if (window.location.href.indexOf('?cookie-control') > -1) {
                                    try {
                                        ...
                                        printError(err, "Cookie Revocation failed. Please contact");
                                    }
                                }
                            }
                        }); //Normal start
  ...
  var adsScrollListener = function() {
    ...
    if (is_desktop) {
        ...
        if ((slot_Box_Article_1 !== undefined) && !refreshedMap["div-Box_Article_1"] && isAdunitWithinYOffset("div-Box_Article_1", desktop_delta)) {
            try {
               // var banner_div_Box_Article_1 = createInTextBannerForDisplay(1);
    ...
    if ((slot_Box_Article_2 !== undefined) && !refreshedMap["div-Box_Article_2"] && isAdunitWithinYOffset("div-Box_Article_2", desktop_delta)) {
            try {
                /* var banner_div_Box_Article_2 = createInTextBannerForDisplay(2);
    ...
    if ((slot_Box_Article_3 !== undefined) && !refreshedMap["div-Box_Article_3"] && isParagraphWithinYOffset(15, desktop_delta)) {
            try {
                var banner_div_Box_Article_3 = createInTextBannerForDisplay(3);
                if (!!banner_div_Box_Article_3 && banner_div_Box_Article_3.setAfterParagraph(15)) {
                    googletag.cmd.push(function() {
                        googletag.display(banner_div_Box_Article_3.id);
                        refreshAdslot(slot_Box_Article_3);
                    });
                } else {
                    printInfo("Not enough paragraphs for inserting " + banner_div_Box_Article_3.id);
                }
            } catch (err) {
     ...
     if ((slot_Box_1 !== undefined) && !refreshedMap["div-Box_1"] && isAdunitWithinYOffset("div-Box_1", desktop_delta)) {
            try {
                googletag.cmd.push(function() {
        ...
        if ((slot_Leaderboard_2 !== undefined) && !refreshedMap["div-Board_2"] && isAdunitWithinYOffset("div-Board_2", desktop_delta)) {
            googletag.cmd.push(function() {
                googletag.display("div-Board_2"); //new
                refreshAdslot(slot_Leaderboard_2);
            });
        }
        if ((slot_Leaderboard_3 !== undefined) && !refreshedMap["div-Board_3"] && isAdunitWithinYOffset("div-Board_3", desktop_delta)) {
          googletag.cmd.push(function() {
              googletag.display("div-Board_3"); //new
              refreshAdslot(slot_Leaderboard_3);
          });
      }
    } else {
       /*  if ((slot_Box_Mobile_Article_1 !== undefined) && !refreshedMap["div-Box_Mobile_Article_1"] && isParagraphWithinYOffset(2, mobile_article_delta)) {           
            try {
                var banner_div_Box_Mobile_Article_1 = createMobileArticleBanner(1);
                if (!!banner_div_Box_Mobile_Article_1 && banner_div_Box_Mobile_Article_1.setAfterParagraph(2)) {
                    googletag.cmd.push(function() {
                        googletag.display("div-Box_Mobile_Article_1");
                        refreshAdslot(slot_Box_Mobile_Article_1);
                    });
                } else {
                    printInfo("Not enough paragraphs for inserting " + banner_div_Box_Mobile_Article_1.id);
                }
            } catch (err) {
                printError(err, "Failed to insert Mobile Article 1");
            }
        } */
        if ((slot_Box_Mobile_Article_2 !== undefined) && !refreshedMap["div-Box_Mobile_Article_2"] && isParagraphWithinYOffset(2, mobile_article_delta)) {
            try {
                var banner_div_Box_Mobile_Article_2 = createMobileArticleBanner(2);
                if (!!banner_div_Box_Mobile_Article_2 && banner_div_Box_Mobile_Article_2.setAfterParagraph(2)) {
                    googletag.cmd.push(function() {
                        googletag.display("div-Box_Mobile_Article_2");
                        refreshAdslot(slot_Box_Mobile_Article_2);
                    });
                } else {
                    printInfo("Not enough paragraphs for inserting " + banner_div_Box_Mobile_Article_2.id);
                }
            } catch (err) {
                printError(err, "Failed to insert Mobile Article 2");
            }
        }
        if ((slot_Box_Mobile_Article_3 !== undefined) && !refreshedMap["div-Box_Mobile_Article_3"] && isParagraphWithinYOffset(6, mobile_article_delta)) {
            try {
                var banner_div_Box_Mobile_Article_3 = createMobileArticleBanner(3);
                if (!!banner_div_Box_Mobile_Article_3 && banner_div_Box_Mobile_Article_3.setAfterParagraph(6)) {
                    googletag.cmd.push(function() {
                        googletag.display(banner_div_Box_Mobile_Article_3.id);
                        refreshAdslot(slot_Box_Mobile_Article_3);
                    });
                } else {
                    printInfo("Not enougn paragraphs for inserting " + banner_div_Box_Mobile_Article_3.id);
                }
            } catch (err) {
        ...
        if ((slot_Box_Mobile_1 !== undefined) && !refreshedMap["div-Box_Mobile_1"] && isAdunitWithinYOffset("div-Box_Mobile_1", mobile_delta)) {
            googletag.cmd.push(function() {
                googletag.display("div-Box_Mobile_1");
                refreshAdslot(slot_Box_Mobile_1);
            });
        }
        if ((slot_Box_Mobile_2 !== undefined) && !refreshedMap["div-Box_Mobile_2"] && isAdunitWithinYOffset("div-Box_Mobile_2", mobile_delta)) {
            googletag.cmd.push(function() {
                googletag.display("div-Box_Mobile_2");
                refreshAdslot(slot_Box_Mobile_2);
            });
        }
        if ((slot_Box_Mobile_3 !== undefined) && !refreshedMap["div-Box_Mobile_3"] && isAdunitWithinYOffset("div-Box_Mobile_3", mobile_delta)) {
          googletag.cmd.push(function() {
        ...
        if (!!slot_Mobile_Anchor && !refreshedMap["gpt_unit_/23209726049/DagsavisenDK/Mobile_Anchor_0"] && ("scrollY" in window) && (window.scrollY > 2500)) {
            googletag.cmd.push(function() {
