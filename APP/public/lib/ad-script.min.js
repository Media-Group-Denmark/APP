  ...
  */
  ...
  improvedigitalPublisherId = 2109;
    ...
    if (prebidEnabled) {
      ...
      enableTIDs: true,
        ...
        if (is_desktop) {
            adUnits = [{
                code: "div-Leaderboard_1",
                ortb2Imp: {
                    ext: {
                        gpid: "/49662453/PengehjoernetDK/Leaderboard_1",
                        data: {
                            pbadslot: "/49662453/PengehjoernetDK/Leaderboard_1"
                        }
                    }
                },
                mediaTypes: {
                ...
                bids: [{
                    bidder: adform,
                    params: {
                        mid: getBidderID('div-Leaderboard_1', adform),
                ...
                code: "div-Leaderboard_2",
                ortb2Imp: {
                    ext: {
                        gpid: "/49662453/PengehjoernetDK/Leaderboard_2",
                        data: {
                            pbadslot: "/49662453/PengehjoernetDK/Leaderboard_2"
                        }
                    }
                },
                mediaTypes: {
                ...
                bids: [{
                    bidder: adform,
                    params: {
                        mid: getBidderID('div-Leaderboard_2', adform),
                        url: pageVariables["canonical-url"],
                        //mkw: adform_keys,
                        mkv: pageVariables["adform-keyvalues"]
                    }
              ...
              code: "div-Leaderboard_3",
              ortb2Imp: {
                  ext: {
                      gpid: "/49662453/PengehjoernetDK/Leaderboard_3",
                      data: {
                          pbadslot: "/49662453/PengehjoernetDK/Leaderboard_3"
                      }
                  }
              },
              mediaTypes: {
              ...
              bids: [{
                  bidder: adform,
                  params: {
                      mid: getBidderID('div-Leaderboard_3', adform),
                      url: pageVariables["canonical-url"],
                      //mkw: adform_keys,
                      mkv: pageVariables["adform-keyvalues"]
                  }
          ...
          },
           {
                ...
                ortb2Imp: {
                    ext: {
                        gpid: "/49662453/PengehjoernetDK/Square_1",
                        data: {
                            pbadslot: "/49662453/PengehjoernetDK/Square_1"
                        }
                    }
                },
                mediaTypes: {
                ...
                bids: [{
                    bidder: adform,
                    params: {
                        mid: getBidderID('div-Square_1', adform),
                        url: pageVariables["canonical-url"],
                        //mkw: adform_keys,
                        mkv: pageVariables["adform-keyvalues"]
                    }
            ...
            adUnits = [{
                ...
                code: "div-Mobile_Square_1",
                ortb2Imp: {
                    ext: {
                        gpid: "/49662453/PengehjoernetDK/Mobile_Square_1",
                        data: {
                            pbadslot: "/49662453/PengehjoernetDK/Mobile_Square_1"
                        }
                    }
                },
                mediaTypes: {
                ...
                bids: [{
                    bidder: adform,
                    params: {
                        mid: getBidderID('div-Mobile_Square_1', adform),
                        url: pageVariables["canonical-url"],
                        //mkw: adform_keys,
                        mkv: pageVariables["adform-keyvalues"]
                    }
                ...
                code: "div-Mobile_Square_2",
                ortb2Imp: {
                    ext: {
                        gpid: "/49662453/PengehjoernetDK/Mobile_Square_2",
                        data: {
                            pbadslot: "/49662453/PengehjoernetDK/Mobile_Square_2"
                        }
                    }
                },
                mediaTypes: {
                ...
                bids: [{
                    bidder: adform,
                    params: {
                        mid: getBidderID('div-Mobile_Square_2', adform),
                        url: pageVariables["canonical-url"],
                        //mkw: adform_keys,
                        mkv: pageVariables["adform-keyvalues"]
                    }
            ...
            {
              code: "div-Mobile_Square_3",
              ortb2Imp: {
                  ext: {
                      gpid: "/49662453/PengehjoernetDK/Mobile_Square_3",
                      data: {
                          pbadslot: "/49662453/PengehjoernetDK/Mobile_Square_3"
                      }
                  }
              },
              mediaTypes: {
              ...
              bids: [{
                  bidder: adform,
                  params: {
                      mid: getBidderID('div-Mobile_Square_3', adform),
                      url: pageVariables["canonical-url"],
                      //mkw: adform_keys,
                      mkv: pageVariables["adform-keyvalues"]
                  }
    ...
    try {
      ...
      if ( (slot_1x1 !== undefined) && !refreshedMap["div-1x1"] ) {
        ...
        //banner_div_Leaderboard_1.setBefore(target);
            ...
            if ((slot_Mobile_Article_1 !== undefined) && !refreshedMap["div-Mobile_Article_1"]) {           
                try {
                        googletag.cmd.push(function() {
            ...
            if ((slot_Mobile_Square_1 !== undefined) && !refreshedMap["div-Mobile_Square_1"] && pageVariables["subsection-category"] !== "articlepage") {
                googletag.cmd.push(function() {
  ...
  var adsScrollListener = function() {
    ...
    if ((slot_InText_5 !== undefined) && !refreshedMap["div-InText_5"] && isParagraphWithinYOffset(25, desktop_delta)) {
     ...
     if ((slot_Square_1 !== undefined) && !refreshedMap["div-Square_1"] && isAdunitWithinYOffset("div-Square_1", desktop_delta)) {
            try {
                googletag.cmd.push(function() {
                    googletag.display("div-Square_1"); //new
                    refreshAdslot(slot_Square_1);
                });
            } catch (err) {
                printError(err, "Failed to insert Square_1");
            }
        }
    
        if ((slot_Leaderboard_2 !== undefined) && !refreshedMap["div-Leaderboard_2"] && isAdunitWithinYOffset("div-Leaderboard_2", desktop_delta)) {
            googletag.cmd.push(function() {
                googletag.display("div-Leaderboard_2"); //new
                refreshAdslot(slot_Leaderboard_2);
            });
        }
        if ((slot_Leaderboard_3 !== undefined) && !refreshedMap["div-Leaderboard_3"] && isAdunitWithinYOffset("div-Leaderboard_3", desktop_delta)) {
          googletag.cmd.push(function() {
              googletag.display("div-Leaderboard_3"); //new
       ...
       /*  if ((slot_Mobile_Article_1 !== undefined) && !refreshedMap["div-Mobile_Article_1"] && isParagraphWithinYOffset(2, mobile_article_delta)) {           
        ...
        if ((slot_Mobile_Article_2 !== undefined) && !refreshedMap["div-Mobile_Article_2"] && isParagraphWithinYOffset(2, mobile_article_delta)) {
            try {
                var banner_div_Mobile_Article_2 = createMobileArticleBanner(2);
                if (!!banner_div_Mobile_Article_2 && banner_div_Mobile_Article_2.setAfterParagraph(2)) {
                    googletag.cmd.push(function() {
        ...
        if ((slot_Mobile_Article_3 !== undefined) && !refreshedMap["div-Mobile_Article_3"] && isParagraphWithinYOffset(6, mobile_article_delta)) {
            try {
                var banner_div_Mobile_Article_3 = createMobileArticleBanner(3);
                if (!!banner_div_Mobile_Article_3 && banner_div_Mobile_Article_3.setAfterParagraph(6)) {
                    googletag.cmd.push(function() {
        ...
        if ((slot_Mobile_Article_4 !== undefined) && !refreshedMap["div-Mobile_Article_4"] && isParagraphWithinYOffset(10, mobile_article_delta)) {
            try {
                var banner_div_Mobile_Article_4 = createMobileArticleBanner(4);
                if (!!banner_div_Mobile_Article_4 && banner_div_Mobile_Article_4.setAfterParagraph(10)) {
                    googletag.cmd.push(function() {
        ...
        if ((slot_Mobile_Article_5 !== undefined) && !refreshedMap["div-Mobile_Article_5"] && isParagraphWithinYOffset(14, mobile_article_delta)) {
            try {
                var banner_div_Mobile_Article_5 = createMobileArticleBanner(5);
                if (!!banner_div_Mobile_Article_5 && banner_div_Mobile_Article_5.setAfterParagraph(14)) {
                    googletag.cmd.push(function() {
        ...
        if ((slot_Mobile_Article_6 !== undefined) && !refreshedMap["div-Mobile_Article_6"] && isParagraphWithinYOffset(18, mobile_article_delta)) {
            try {
                var banner_div_Mobile_Article_6 = createMobileArticleBanner(6);
                if (!!banner_div_Mobile_Article_6 && banner_div_Mobile_Article_6.setAfterParagraph(18)) {
                    googletag.cmd.push(function() {
    ...
    if ((slot_Mobile_Article_7 !== undefined) && !refreshedMap["div-Mobile_Article_7"] && isParagraphWithinYOffset(22, mobile_article_delta)) {
            try {
                var banner_div_Mobile_Article_7 = createMobileArticleBanner(7);
                if (!!banner_div_Mobile_Article_7 && banner_div_Mobile_Article_7.setAfterParagraph(22)) {
                    googletag.cmd.push(function() {
    ...
    if ((slot_Mobile_Article_8 !== undefined) && !refreshedMap["div-Mobile_Article_8"] && isParagraphWithinYOffset(37, mobile_article_delta)) {
        ...
        if ((slot_Mobile_Square_1 !== undefined) && !refreshedMap["div-Mobile_Square_1"] && isAdunitWithinYOffset("div-Mobile_Square_1", mobile_delta)) {
            googletag.cmd.push(function() {
                googletag.display("div-Mobile_Square_1");
                refreshAdslot(slot_Mobile_Square_1);
            });
        }
        if ((slot_Mobile_Square_2 !== undefined) && !refreshedMap["div-Mobile_Square_2"] && isAdunitWithinYOffset("div-Mobile_Square_2", mobile_delta)) {
            googletag.cmd.push(function() {
                googletag.display("div-Mobile_Square_2");
                refreshAdslot(slot_Mobile_Square_2);
            });
        }
        if ((slot_Mobile_Square_3 !== undefined) && !refreshedMap["div-Mobile_Square_3"] && isAdunitWithinYOffset("div-Mobile_Square_3", mobile_delta)) {
          googletag.cmd.push(function() {
              googletag.display("div-Mobile_Square_3");
              refreshAdslot(slot_Mobile_Square_3);
          });
      }
