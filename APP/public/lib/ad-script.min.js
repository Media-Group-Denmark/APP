...
function initATFAds() {
    ...
    try {
        if (pageVariables["environment"] !== "NoAds") {
            /*if ((slot_InText_1 !== undefined) && !refreshedMap["div-InText_1"] && isParagraphWithinYOffset(1, desktop_delta)) {
                try {
                    var banner_div_InText_1 = createInTextBannerForDisplay(1);
                    if (!!banner_div_InText_1 && banner_div_InText_1.setAfterParagraph(1)) {
                        googletag.cmd.push(function() {
                            googletag.display(banner_div_InText_1.id);
                            refreshAdslot(slot_InText_1);
                        });
                    } else {
                        printInfo("Not enougn paragraphs for inserting " + banner_div_InText_1.id);
                    }
                } catch (err) {
            ...
            /* if ((slot_InFeed_1 !== undefined) && !refreshedMap["div-InFeed_1"]) {
				var sidebarInner = document.getElementById("trending");
				if (!!sidebarInner) {
					var banner_div_InFeed_1 = document.createElement("div");
					banner_div_InFeed_1.id = "div-InFeed_1";
					sidebarInner.appendChild(banner_div_InFeed_1);
				}
            } */
            ...
            /*if ((slot_Mobile_Article_1 !== undefined) && !refreshedMap["div-Mobile_Article_1"] && isAdunitWithinYOffset("div-Mobile_Article_1", mobile_delta)) {
                googletag.cmd.push(function() {
                    googletag.display("div-Mobile_Article_1"); //new
                    refreshAdslot(slot_Mobile_Article_1);
                });
            }*/
			/*
            if ((slot_Mobile_Article_1 !== undefined) && !refreshedMap["div-Mobile_Article_1"] && isParagraphWithinYOffset(1, mobile_article_delta)) {
                try {
                    var banner_div_Mobile_Article_1 = createMobileArticleBanner(1);
                    if (!!banner_div_Mobile_Article_1 && banner_div_Mobile_Article_1.setAfterParagraph(1)) {
                        googletag.cmd.push(function() {
                            googletag.display(banner_div_Mobile_Article_1.id);
                            refreshAdslot(slot_Mobile_Article_1);
                        });
                    } else {
...
var adsScrollListener = function() {
    ...
    if (is_desktop) {
		...
		if ((slot_InText_2 !== undefined) && !refreshedMap["div-InText_2"] && isParagraphWithinYOffset(10, desktop_delta)) {
            try {
                var banner_div_InText_2 = createInTextBannerForDisplay(2);
                if (!!banner_div_InText_2 && banner_div_InText_2.setAfterParagraph(10)) {
                    googletag.cmd.push(function() {
                        googletag.display(banner_div_InText_2.id);
        ...
        if ((slot_Mobile_Article_2 !== undefined) && !refreshedMap["div-Mobile_Article_2"] && isParagraphWithinYOffset(7, mobile_article_delta)) {
            try {
                ...
                if (!!banner_div_Mobile_Article_2 && banner_div_Mobile_Article_2.setAfterParagraph(7)) {
                    googletag.cmd.push(function() {
                        googletag.display(banner_div_Mobile_Article_2.id);
