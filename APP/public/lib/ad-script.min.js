  ...
  if (prebidEnabled) {
    ...
    if (is_desktop) {
      adUnits = [
        ...
        {
          code: "div-Box_Article_4",
          ortb2Imp: {
            ext: {
              gpid: "/23209726049/DagsavisenDK/Box_Article_4",
              data: {
                pbadslot: "/23209726049/DagsavisenDK/Box_Article_4",
              },
            },
          },
          mediaTypes: {
          ...
          bids: [
            {
              bidder: adform,
              params: {
                mid: getBidderID("div-Box_Article_4", adform),
                url: pageVariables["canonical-url"],
                //mkw: adform_keys,
                mkv: pageVariables["adform-keyvalues"],
              },
        ...
        {
          code: "div-Box_Article_5",
          ortb2Imp: {
            ext: {
              gpid: "/23209726049/DagsavisenDK/Box_Article_5",
              data: {
                pbadslot: "/23209726049/DagsavisenDK/Box_Article_5",
              },
            },
          },
          mediaTypes: {
          ...
          bids: [
            {
              bidder: adform,
              params: {
                mid: getBidderID("div-Box_Article_5", adform),
                url: pageVariables["canonical-url"],
                //mkw: adform_keys,
                mkv: pageVariables["adform-keyvalues"],
              },
      ...
      adUnits = [
        ...
        {
          code: "div-Box_Mobile_Article_4",
          ortb2Imp: {
            ext: {
              gpid: "/23209726049/DagsavisenDK/Box_Mobile_Article_4",
              data: {
                pbadslot: "/23209726049/DagsavisenDK/Box_Mobile_Article_4",
              },
            },
          },
          mediaTypes: {
          ...
          bids: [
            {
              bidder: adform,
              params: {
                mid: getBidderID("div-Box_Mobile_Article_4", adform),
                url: pageVariables["canonical-url"],
                //mkw: adform_keys,
                mkv: pageVariables["adform-keyvalues"],
              },
        ...
        {
          code: "div-Box_Mobile_Article_5",
          ortb2Imp: {
            ext: {
              gpid: "/23209726049/DagsavisenDK/Box_Mobile_Article_5",
              data: {
                pbadslot: "/23209726049/DagsavisenDK/Box_Mobile_Article_5",
              },
            },
          },
          mediaTypes: {
          ...
          bids: [
            {
              bidder: adform,
              params: {
                mid: getBidderID("div-Box_Mobile_Article_5", adform),
                url: pageVariables["canonical-url"],
                //mkw: adform_keys,
                mkv: pageVariables["adform-keyvalues"],
              },
        ...
        {
          code: "div-Box_Mobile_Article_6",
          ortb2Imp: {
            ext: {
              gpid: "/23209726049/DagsavisenDK/Box_Mobile_Article_6",
              data: {
                pbadslot: "/23209726049/DagsavisenDK/Box_Mobile_Article_6",
              },
            },
          },
          mediaTypes: {
          ...
          bids: [
            {
              bidder: adform,
              params: {
                mid: getBidderID("div-Box_Mobile_Article_6", adform),
                url: pageVariables["canonical-url"],
                //mkw: adform_keys,
                mkv: pageVariables["adform-keyvalues"],
              },
        ...
        {
          code: "div-Box_Mobile_Article_7",
          ortb2Imp: {
            ext: {
              gpid: "/23209726049/DagsavisenDK/Box_Mobile_Article_7",
              data: {
                pbadslot: "/23209726049/DagsavisenDK/Box_Mobile_Article_7",
              },
            },
          },
          mediaTypes: {
          ...
          bids: [
            {
              bidder: adform,
              params: {
                mid: getBidderID("div-Box_Mobile_Article_7", adform),
                url: pageVariables["canonical-url"],
                //mkw: adform_keys,
                mkv: pageVariables["adform-keyvalues"],
              },
        ...
        {
          code: "div-Box_Mobile_Article_8",
          ortb2Imp: {
            ext: {
              gpid: "/23209726049/DagsavisenDK/Box_Mobile_Article_8",
              data: {
                pbadslot: "/23209726049/DagsavisenDK/Box_Mobile_Article_8",
              },
            },
          },
          mediaTypes: {
          ...
          bids: [
            {
              bidder: adform,
              params: {
                mid: getBidderID("div-Box_Mobile_Article_8", adform),
                url: pageVariables["canonical-url"],
                //mkw: adform_keys,
                mkv: pageVariables["adform-keyvalues"],
              },
...
var adsScrollListener = function () {
  if (is_desktop) {
    ...
    if (
      slot_Box_Article_4 !== undefined &&
      !refreshedMap["div-Box_Article_4"] &&
      isParagraphWithinYOffset(20, desktop_delta)
    ) {
      try {
        var banner_div_Box_Article_4 = createBox_ArticleBannerForDisplay(4);
        if (
          !!banner_div_Box_Article_4 &&
          banner_div_Box_Article_4.setAfterParagraph(20)
        ) {
          googletag.cmd.push(function () {
            googletag.display(banner_div_Box_Article_4.id);
            refreshAdslot(slot_Box_Article_4);
          });
        } else {
          printInfo(
            "Not enough paragraphs for inserting " + banner_div_Box_Article_4.id
          );
        }
      } catch (err) {
        printError(err, "Failed to insert Box_Article 4");
      }
    }

    if (
      slot_Box_Article_5 !== undefined &&
      !refreshedMap["div-Box_Article_5"] &&
      isParagraphWithinYOffset(25, desktop_delta)
    ) {
      try {
        var banner_div_Box_Article_5 = createBox_ArticleBannerForDisplay(5);
        if (
          !!banner_div_Box_Article_5 &&
          banner_div_Box_Article_5.setAfterParagraph(25)
        ) {
          googletag.cmd.push(function () {
            googletag.display(banner_div_Box_Article_5.id);
            refreshAdslot(slot_Box_Article_5);
          });
        } else {
          printInfo(
            "Not enough paragraphs for inserting " + banner_div_Box_Article_5.id
          );
        }
      } catch (err) {
        printError(err, "Failed to insert Box_Article 5");
      }
    }
    ...
    if (
      slot_Box_Mobile_Article_4 !== undefined &&
      !refreshedMap["div-Box_Mobile_Article_4"] &&
      isParagraphWithinYOffset(17, mobile_article_delta)
    ) {
      try {
        var banner_div_Box_Mobile_Article_4 = createMobileArticleBanner(4);
        if (
          !!banner_div_Box_Mobile_Article_4 &&
          banner_div_Box_Mobile_Article_4.setAfterParagraph(17)
        ) {
          googletag.cmd.push(function () {
            googletag.display(banner_div_Box_Mobile_Article_4.id);
            refreshAdslot(slot_Box_Mobile_Article_4);
          });
        } else {
          printInfo(
            "Not enougn paragraphs for inserting " +
              banner_div_Box_Mobile_Article_4.id
          );
        }
      } catch (err) {
    ...
    if (
      slot_Box_Mobile_Article_5 !== undefined &&
      !refreshedMap["div-Box_Mobile_Article_5"] &&
      isParagraphWithinYOffset(22, mobile_article_delta)
    ) {
      try {
        var banner_div_Box_Mobile_Article_5 = createMobileArticleBanner(5);
        if (
          !!banner_div_Box_Mobile_Article_5 &&
          banner_div_Box_Mobile_Article_5.setAfterParagraph(22)
        ) {
          googletag.cmd.push(function () {
            googletag.display(banner_div_Box_Mobile_Article_5.id);
            refreshAdslot(slot_Box_Mobile_Article_5);
          });
        } else {
          printInfo(
            "Not enougn paragraphs for inserting " +
              banner_div_Box_Mobile_Article_5.id
          );
        }
      } catch (err) {
    ...
    if (
      slot_Box_Mobile_Article_6 !== undefined &&
      !refreshedMap["div-Box_Mobile_Article_6"] &&
      isParagraphWithinYOffset(27, mobile_article_delta)
    ) {
      try {
        var banner_div_Box_Mobile_Article_6 = createMobileArticleBanner(6);
        if (
          !!banner_div_Box_Mobile_Article_6 &&
          banner_div_Box_Mobile_Article_6.setAfterParagraph(27)
        ) {
          googletag.cmd.push(function () {
            googletag.display(banner_div_Box_Mobile_Article_6.id);
            refreshAdslot(slot_Box_Mobile_Article_6);
          });
        } else {
          printInfo(
            "Not enougn paragraphs for inserting " +
              banner_div_Box_Mobile_Article_6.id
          );
        }
      } catch (err) {
    ...
    if (
      slot_Box_Mobile_Article_7 !== undefined &&
      !refreshedMap["div-Box_Mobile_Article_7"] &&
      isParagraphWithinYOffset(32, mobile_article_delta)
    ) {
      try {
        var banner_div_Box_Mobile_Article_7 = createMobileArticleBanner(7);
        if (
          !!banner_div_Box_Mobile_Article_7 &&
          banner_div_Box_Mobile_Article_7.setAfterParagraph(32)
        ) {
          googletag.cmd.push(function () {
            googletag.display(banner_div_Box_Mobile_Article_7.id);
            refreshAdslot(slot_Box_Mobile_Article_7);
          });
        } else {
          printInfo(
            "Not enougn paragraphs for inserting " +
              banner_div_Box_Mobile_Article_7.id
          );
        }
      } catch (err) {
    ...
    if (
      slot_Box_Mobile_Article_8 !== undefined &&
      !refreshedMap["div-Box_Mobile_Article_8"] &&
      isParagraphWithinYOffset(37, mobile_article_delta)
    ) {
      try {
        var banner_div_Box_Mobile_Article_8 = createMobileArticleBanner(8);
        if (
          !!banner_div_Box_Mobile_Article_8 &&
          banner_div_Box_Mobile_Article_8.setAfterParagraph(37)
        ) {
          googletag.cmd.push(function () {
            googletag.display(banner_div_Box_Mobile_Article_8.id);
            refreshAdslot(slot_Box_Mobile_Article_8);
          });
        } else {
          printInfo(
            "Not enougn paragraphs for inserting " +
              banner_div_Box_Mobile_Article_8.id
          );
        }
      } catch (err) {
