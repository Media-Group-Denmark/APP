...
export const metadata: Metadata = {
  title: 'Vores Journalister | Pengehjørnet',
  description: 'Mød teamet af eksperter og journalister bag Pengehjørnet, der bringer dig de seneste indsigter inden for økonomi, aktier, og investering.',
  keywords: 'journalister, økonomieksperter, Pengehjørnet team, finansielle analytikere',
  openGraph: {
    title: 'Vores Journalister | Pengehjørnet',
    description: 'Mød teamet af eksperter og journalister bag Pengehjørnet, der bringer dig de seneste indsigter inden for økonomi, aktier, og investering.',
    ...
    images: [
      {
        ...
        width: 800,
        height: 600,
        alt: 'Mød vores journalister - Pengehjørnet',
      }
    ]
  },
  twitter: {
  ...
  <ol className="inline-flex items-center space-x-1 md:space-x-3">
    ...
    <li className=" cursor-default " aria-current="page">
      <div className="flex items-center">
        ...
        <span className="text-accent_color_light dark:text-accent_color_dark ml-1 md:ml-2 text-sm font-medium capitalize ">Journalister</span>
      </div>
    </li>
  </ol>
</nav>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
    {
        ...
        <Link href={`/artikler/journalist/${journalist.slug}`}>
            <div className="w-full bg-second_color_light dark:bg-second_color_dark rounded-lg p-12 flex flex-col justify-center items-center cursor-pointer">
                <div className="mb-8">
                <Image className="object-center object-cover rounded-full h-24 w-24" alt={journalist.name} width={200} height={200} src={
                              journalist.image
                                ? urlFor(journalist.image).format("webp")
      .width(400)
      .height(300)
      .fit("fill")
      .quality(85)
      .url()
                ...
                <div className="text-center">
                    <p className="text-xl text-text_main_color_dark dark:text-text_main_color_light font-bold mb-2">{journalist.name}</p>
                    <p className="text-base text-gray-400 font-normal">Journalist</p>
                </div>
            </div>
        </Link>
        ))
