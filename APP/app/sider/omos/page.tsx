...
export const metadata: Metadata = {
    title: 'Om Os | Pengehjørnet',
    description: 'Lær mere om Pengehjørnet og vores mission om at oplyse unge i Danmark om økonomi, investering, og skat.',
    keywords: 'om os, Pengehjørnet, økonomi, investering, skat, finansiel uddannelse',
    openGraph: {
      title: 'Om Os | Pengehjørnet',
      description: 'Lær mere om Pengehjørnet og vores mission om at oplyse unge i Danmark om økonomi, investering, og skat.',
      url: 'https://xn--pengehjrnet-mgb.dk/sider/om-os',
      type: 'website',
...
export default async function omos() {
  ...
  return (
    <>
    {
        data ? (
<>
  <nav className="flex px-3 md:px-8 max-w-[1280px] m-auto pt-6 rounded-lg " aria-label="Breadcrumb">
