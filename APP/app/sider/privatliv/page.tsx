...
export const metadata: Metadata = {
    title: 'Privatlivspolitik | Pengehjørnet',
    description: 'Opdag, hvordan Pengehjørnet beskytter og håndterer dine personlige oplysninger. Læs vores forpligtelse til privatlivets fred.',
    keywords: 'privatlivspolitik, personlige oplysninger, databeskyttelse, Pengehjørnet',
    openGraph: {
      title: 'Privatlivspolitik | Pengehjørnet',
      description: 'Opdag, hvordan Pengehjørnet beskytter og håndterer dine personlige oplysninger. Læs vores forpligtelse til privatlivets fred.',
      url: 'https://xn--pengehjrnet-mgb.dk/sider/privatliv',
      type: 'article',
      ...
      images: [
        {
          ...
          width: 800,
          height: 600,
          alt: 'Privatlivspolitik - Pengehjørnet',
        }
      ]
    },
    twitter: {
