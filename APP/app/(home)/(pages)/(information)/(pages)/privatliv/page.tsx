...
import { privacyPageMeta } from "./meta/privacyPageMeta";
import '@/app/(home)/(pages)/artikel/stylesheets/articleText.css';
export const revalidate = 80000;
/* -------------------------------------------------------------------------- */
/*                                  METADATA                                  */
/* -------------------------------------------------------------------------- */
export const metadata: Metadata = privacyPageMeta;
/* -------------------------------------------------------------------------- */
...
export default async function privatliv() {
  ...
  /*                                   CONTENT                                  */
  /* -------------------------------------------------------------------------- */
  const data: Reference[] = await getPrivacyPage();
  return (
    <section>
      {data ? (
        <>
          <CustomBreadcrumb navItem={"Privatliv"} link="" navItemTwo="" />
